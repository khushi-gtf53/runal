...
const Blogs = () => {
    ...
    return (
        <section className="blogs w-full h-auto py-20 bg-[url(/assets/home/blog/blog_bg.webp)] bg-no-repeat bg-center bg-cover">
            <div className="relative max-w-6xl mx-auto h-full flex flex-col items-center sm:text-center px-4">
                ...
                <div className="blog_sec relative pb-40 mt-10" ref={blogRef}>
                    {blogData.map((blog, i) => (
